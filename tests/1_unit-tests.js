...
suite('Unit Tests', function () {
  ...
  suite('Arrays', function () {
    ...
    test('Array #include, #notInclude', function () {
      assert.include(winterMonths, 'jan', "It's winter in January");
      assert.notInclude(backendLanguages, 'typescript', 'TS is not a backend language in this list');
    });
  });
  ...
  suite('Strings', function () {
    ...
    test('#isString, #isNotString', function () {
      ...
      assert.isString(process.env.PATH, 'An env variable is a string');
